...
export default function RegisterAssignment({}: Props) {
  return (
    <div className="w-full select-none cursor-pointer  border border-[#FFEBD5] hover:border-[#FF8800] hover:border-opacity-30 transition-all p-5 h-24 flex rounded-[9px] items-center justify-start bg-[#FFEBD5]">
