...
export default function Cta({ link, text }: Props) {
  return (
    <Link
      href={link}
      className={`${asap.className} antialiased bg-secondary-500 rounded-xl font-medium text-white w-min whitespace-nowrap shadow-[0px_2px_8px_0px_rgba(153,153,153,0.20)]`}
    >
