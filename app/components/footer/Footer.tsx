...
export default function Footer() {
  return (
    <footer className="bg-primary-800 w-full h-full flex flex-col gap-20 px-4 lg:px-20 pt-[72px] lg:pt-20 pb-10">
      <div className="max-w-screen-xl w-full mx-auto grid grid-cols-1 lg:grid-cols-4 text-white gap-y-12 gap-8">
        <Image src={"/logo.png"} height={52} width={177} alt="Invoicery" className="block mx-auto lg:hidden"/>
