...
//   // Extract form data
//   const firstNameLabel = formData.get("firstNameLabel");
//   const lastNameLabel = formData.get("lastNameLabel");
//   const personalIdLabel = formData.get("personalIdLabel");
//   const addressLine1Label = formData.get("addressLine1Label");
//   const coLabel = formData.get("coLabel");
//   const zipCodeLabel = formData.get("zipCodeLabel");
//   const cityLabel = formData.get("cityLabel");
//   const countryLabel = formData.get("countryLabel");
//   const ibanLabel = formData.get("ibanLabel");
//   const bicLabel = formData.get("bicLabel");
...
//   if (passportFile) {
//     console.log("Passport File Info:", {
//       name: passportFile.name,
//       type: passportFile.type,
//       size: passportFile.size,
//     });

//     // Proceed to upload the file to Supabase or process it as needed
//     // For example, you might use Supabase Storage:
//     // const { data, error } = await supabase.storage
//     //   .from('passports')
//     //   .upload(`passports/${passportFile.name}`, passportFile);

//     // Handle the response accordingly
//   } else {
//     console.log("No passport file provided.");
//   }
// }
